  ...
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
        <h1 className="text-4xl font-heading font-bold text-white mb-6">Para Fornecedores</h1>
        <p className="text-lg text-slate-300">Informações e processos para parcerias comerciais com a Ativa Serviços.</p>
      </motion.div>
...
export function Politicas() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
        <h1 className="text-4xl font-heading font-bold text-white mb-6">Políticas e Documentos Oficiais</h1>
        <p className="text-lg text-slate-300">Acesse nossos documentos e diretrizes institucionais.</p>
      </motion.div>
...
export function Mapa() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
        <h1 className="text-4xl font-heading font-bold text-white mb-6">Nossa Localização</h1>
        <p className="text-lg text-slate-300">Venha nos fazer uma visita.</p>
      </motion.div>
...
export function TrabalheConosco() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
        <h1 className="text-4xl font-heading font-bold text-white mb-6">Trabalhe Conosco</h1>
        <p className="text-lg text-slate-300 max-w-3xl mx-auto">
          Faça parte de uma equipe comprometida com a excelência, que valoriza as pessoas e atua em âmbito nacional (MG, SP, GO e DF).
        </p>
      </motion.div>
...
export function Colaborador() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
        <h1 className="text-4xl font-heading font-bold text-white mb-6">Portal do Colaborador</h1>
        <p className="text-lg text-slate-300">Recursos e materiais para a sua jornada na Ativa Serviços.</p>
      </motion.div>
...
export function InstitucionalPdf() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
      <h1 className="text-4xl font-heading font-bold text-white mb-6">Apresentação Institucional</h1>
...
export function Teste() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
      <h1 className="text-4xl font-heading font-bold text-white mb-6">Página de Teste</h1>
      <div className="bg-brand-800/40 p-12 rounded-2xl border border-brand-700/50">
...
export function EntrevistaOnline() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
      <h1 className="text-4xl font-heading font-bold text-white mb-6">Entrevista Online</h1>
      <p className="text-lg text-slate-300 mb-10">Deseja agendar sua entrevista online? Fale diretamente com nossa equipe de recrutamento.</p>
...
export function Culturativa() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
        <h1 className="text-4xl font-heading font-bold text-white mb-6">Culturativa</h1>
        <p className="text-lg text-slate-300">Cartas destinadas às nossas lideranças e multiplicadores sobre cultura e atuação profissional.</p>
      </motion.div>
...
export function Formularios() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
        <h1 className="text-4xl font-heading font-bold text-white mb-6">Formulários Internos</h1>
        <p className="text-lg text-slate-300">Acesso a solicitações operacionais.</p>
      </motion.div>
...
export function Ouvidoria() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
        <h1 className="text-4xl font-heading font-bold text-white mb-6">Ouvidoria</h1>
        <p className="text-lg text-slate-300 max-w-3xl mx-auto">
          Canal exclusivo para registro de reclamações, sugestões, denúncias e elogios de forma segura.
        </p>
      </motion.div>
...
export function CCT({ title, id }: { title: string, id: string }) {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
      <h1 className="text-4xl font-heading font-bold text-white mb-6">Convenção Coletiva de Trabalho</h1>
      <h2 className="text-2xl text-brand-green mb-10">{title}</h2>
      <div className="bg-brand-800/40 p-12 rounded-2xl border border-brand-700/50">
...
export function Club() {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
      <h1 className="text-4xl font-heading font-bold text-white mb-6">Clube de Vantagens</h1>
      <div className="bg-brand-800/40 p-12 rounded-2xl border border-brand-700/50">
