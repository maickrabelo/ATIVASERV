  ...
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20 items-start">
        ...
        <div className="bg-brand-800/30 p-8 rounded-2xl border border-brand-700/50">
          <h3 className="text-2xl font-heading font-bold text-white mb-6">Benefícios Operacionais</h3>
          <ul className="space-y-4">
            {[
              ...
              "Possíveis reduções de custos fiscais, dependendo da análise tributária (PIS/COFINS, IR/CSLL aplicáveis ao seu regime)"
            ].map((beneficio, i) => (
